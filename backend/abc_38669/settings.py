"""
Django settings for abc_38669 project.
...
WSGI_APPLICATION = 'abc_38669.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "abc_38669 API",
    "DESCRIPTION": "API documentation for abc_38669 App",
    "VERSION": "v1",
}
